...
class PriceRepositoryTest {
	...
	@Test
	void givenJune13at23h59m59s_whenFindValidPrice_thenNoContent() {
		this.assertNoPrice("2020-06-13T23:59:59");
	}
	
	@Test
	void givenJune14at00h00m_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-14T00:00:00", 1L);
	}
	
	@Test
	void givenJune14at14h59m_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-14T14:59:59", 1L);
	}
	
	@Test
	void givenJune14at15h00m_whenFindValidPrice_thenGet2() {
		this.assertIsExpectedPrice("2020-06-14T15:00:00", 2L);
	}
	
	@Test
	void givenJune14at18h30m_whenFindValidPrice_thenGet2() {
		this.assertIsExpectedPrice("2020-06-14T18:30:00", 2L);
	}
	
	@Test
	void givenJune14at18h30m01s_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-14T18:30:01", 1L);
	}
	
	@Test
	void givenJune14at23h59m59s_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-14T23:59:59", 1L);
	}
	
	@Test
	void givenJune15at00h00m_whenFindValidPrice_thenGet3() {
		this.assertIsExpectedPrice("2020-06-15T00:00:00", 3L);
	}
	
	@Test
	void givenJune15at11h00m_whenFindValidPrice_thenGet3() {
		this.assertIsExpectedPrice("2020-06-15T11:00:00", 3L);
	}
	
	@Test
	void givenJune15at11h00m01s_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-15T11:00:01", 1L);
	}
	
	@Test
	void givenJune15at15h59m59s_whenFindValidPrice_thenGet1() {
		this.assertIsExpectedPrice("2020-06-15T15:59:59", 1L);
	}
	
	@Test
	void givenJune15at16h00m_whenFindValidPrice_thenGet4() {
		this.assertIsExpectedPrice("2020-06-15T16:00:00", 4L);
	}
	
	@Test
	void givenDec31at23h59m59s_whenFindValidPrice_thenGet4() {
		this.assertIsExpectedPrice("2020-12-31T23:59:59", 4L);
	}
	
	@Test
	void givenJan01at00h00m_whenFindValidPrice_thenNoContent() {
